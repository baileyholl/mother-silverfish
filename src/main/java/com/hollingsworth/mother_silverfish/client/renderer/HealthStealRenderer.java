...
public class HealthStealRenderer extends MobRenderer<Silverfish, ColoredFishModel<Silverfish>> {
    private static final ResourceLocation SILVERFISH_LOCATION = new ResourceLocation("textures/entity/silverfish.png");

    public HealthStealRenderer(EntityRendererProvider.Context p_174378_) {
        super(p_174378_, new ColoredFishModel(p_174378_.bakeLayer(ModelLayers.SILVERFISH), 1.0f, 0.5f, 0.5f), 0.3F);
    }
